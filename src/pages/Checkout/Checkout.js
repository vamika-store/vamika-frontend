  ...
  return (
    <div className='p-8 flex'>
      <div className='w-[70%]'>
        ...
        { paymentMethod !== 'CARD' && <button className='w-[150px] item-center h-[48px] bg-black border rounded-lg mt-2 text-white hover:bg-black-800' onClick={() => navigate('/payment')} >Pay Now</button>}
      </div>
